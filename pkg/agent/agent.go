...
func (r Runner) Run(ctx context.Context, userToken, purpose string, mode Mode) error {
	...
	req, err := http.NewRequestWithContext(ctx, http.MethodPost, target, strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"tools/call","params":{"name":"system.whoami","arguments":{}}}`))
	if err != nil {
		return err
	}
