...
supported staging deploy directory and one minimal parameterized bulk operation
that rotates the pre-existing `Administrator` account to the Vault-injected
password. Task 53 configures scopes, processors,
